...
class SalaNScreen extends StatefulWidget {
  final String docid;

  SalaNScreen({Key? key, required this.docid}) : super(key: key);

  @override
  _SalaNScreenState createState() => _SalaNScreenState();
}

class _SalaNScreenState extends State<SalaNScreen> {
  CollectionReference froodref = FirebaseFirestore.instance.collection("naualfil");
